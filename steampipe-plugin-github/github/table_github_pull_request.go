...
func sharedPullRequestColumns() []*plugin.Column {
	return []*plugin.Column{
		...
		{Name: "closed_at", Type: proto.ColumnType_TIMESTAMP,
			Transform:   transform.FromField("Description.ClosedAt").Transform(convertTimestamp),
		...
		{Name: "merged_at", Type: proto.ColumnType_TIMESTAMP,
			Transform:   transform.FromField("Description.MergedAt").Transform(convertTimestamp),
