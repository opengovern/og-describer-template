...
func tableGitHubWorkflow() *plugin.Table {
	return &plugin.Table{
		...
		Columns: commonColumns([]*plugin.Column{
			...
			{Name: "created_at", Type: proto.ColumnType_TIMESTAMP, Transform: transform.FromField("Description.CreatedAt").Transform(convertTimestamp),
			...
			{Name: "updated_at", Type: proto.ColumnType_TIMESTAMP, Transform: transform.FromField("Description.UpdatedAt").Transform(convertTimestamp), Description: "Time when the workflow was updated."},
