...
func tableEntraIdApplicationAppRoleAssignment(_ context.Context) *plugin.Table {
	return &plugin.Table{
		Name:        "entraid_application_app_role_assigned_to",
		...
		Get: &plugin.GetConfig{
			Hydrate: opengovernance.GetApplicationAppRoleAssignedTo,
			KeyColumns: plugin.KeyColumnSlice{
				{Name: "id", Require: plugin.Required},
			},
		},
		List: &plugin.ListConfig{
			Hydrate: opengovernance.ListApplicationAppRoleAssignedTo,
		},
