...
func tableEntraIdServicePrincipalAppRoleAssignment(_ context.Context) *plugin.Table {
	return &plugin.Table{
		Name:        "entraid_service_principal_app_role_assignment",
		...
		Get: &plugin.GetConfig{
			Hydrate: opengovernance.GetServicePrincipalAppRoleAssignment,
			KeyColumns: plugin.KeyColumnSlice{
				{Name: "id", Require: plugin.Required},
			},
		},
		List: &plugin.ListConfig{
			Hydrate: opengovernance.ListServicePrincipalAppRoleAssignment,
		},
