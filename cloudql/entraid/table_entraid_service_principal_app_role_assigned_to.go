...
func tableEntraIdServicePrincipalAppRoleAssignedTo(_ context.Context) *plugin.Table {
	return &plugin.Table{
		Name:        "entraid_service_principal_app_role_assigned_to",
		...
		Get: &plugin.GetConfig{
			Hydrate: opengovernance.GetServicePrincipalAppRoleAssignedTo,
			KeyColumns: plugin.KeyColumnSlice{
				{Name: "id", Require: plugin.Required},
			},
		},
		List: &plugin.ListConfig{
			Hydrate: opengovernance.ListServicePrincipalAppRoleAssignedTo,
		},
		...
		Columns: []*plugin.Column{
			...
			// Standard columns
			{
				...
				Transform:   transform.FromField("Description.ServicePrincipalId"),
			},
		},
	}
}
