...
import (
	"context"
	github "github.com/opengovern/og-describer-github/discovery/provider"
...
var listRepositoryFilters = map[string]string{
	"allow_update_branch":              "Description.RepositorySettings.AllowUpdateBranch",
	"archived_at":                      "Description.ArchivedAt",
	"auto_merge_allowed":               "Description.RepositorySettings.AllowAutoMerge",
	...
	"delete_branch_on_merge":           "Description.RepositorySettings.DeleteBranchOnMerge",
	"description":                      "Description.Description",
	"disk_usage":                       "Description.DiskUsage",
	"fork_count":                       "Description.Metrics.Forks",
	"forking_allowed":                  "Description.RepositorySettings.ForkingAllowed",
	"github_repo_id":                   "Description.GitHubRepoID",
	"has_discussions_enabled":          "Description.RepositorySettings.HasDiscussionsEnabled",
	"has_downloads":                    "Description.RepositorySettings.HasDownloads",
	"has_issues_enabled":               "Description.RepositorySettings.HasIssuesEnabled",
	"has_pages":                        "Description.RepositorySettings.HasPages",
	"has_projects_enabled":             "Description.RepositorySettings.HasProjectsEnabled",
	"has_vulnerability_alerts_enabled": "Description.SecuritySettings.VulnerabilityAlertsEnabled",
	"has_wiki_enabled":                 "Description.RepositorySettings.HasWikiEnabled",
	"homepage_url":                     "Description.HomepageURL",
	"hooks":                            "Description.Hooks",
	"id":                               "Description.GitHubRepoID",
	"interaction_ability":              "Description.InteractionAbility",
	"is_active":                        "Description.IsActive",
	"is_archived":                      "Description.RepositorySettings.Archived",
	"is_blank_issues_enabled":          "Description.RepositorySettings.BlankIssuesEnabled",
	"is_disabled":                      "Description.RepositorySettings.Disabled",
	"is_empty":                         "Description.IsEmpty",
	"is_fork":                          "Description.IsFork",
	"is_in_organization":               "Description.RepositorySettings.IsInOrganization",
	"is_locked":                        "Description.RepositorySettings.Locked",
	"is_mirror":                        "Description.RepositorySettings.IsMirror",
	"is_private":                       "Description.RepositorySettings.IsPrivate",
	"is_security_policy_enabled":       "Description.IsSecurityPolicyEnabled",
	"is_template":                      "Description.RepositorySettings.IsTemplate",
	...
	"merge_commit_allowed":             "Description.RepositorySettings.MergeCommitAllowed",
	"merge_commit_message":             "Description.RepositorySettings.MergeCommitMessage",
	"merge_commit_title":               "Description.RepositorySettings.MergeCommitTitle",
	"mirror_url":                       "Description.RepositorySettings.MirrorURL",
	"name":                             "Description.Name",
	...
	"squash_merge_allowed":             "Description.RepositorySettings.SquashMergeAllowed",
	"squash_merge_commit_message":      "Description.RepositorySettings.SquashMergeCommitMessage",
	"squash_merge_commit_title":        "Description.RepositorySettings.SquashMergeCommitTitle",
	"ssh_url":                          "Description.RepoURLs.SSHURL",
	"stargazer_count":                  "Description.Metrics.Stargazers",
	"subscribers_count":                "Description.Metrics.Subscribers",
	"topics":                           "Description.Topics",
	"updated_at":                       "Description.UpdatedAt",
	"url":                              "Description.RepoURLs.GitURL",
	"uses_custom_open_graph_image":     "Description.UsesCustomOpenGraphImage",
	"visibility":                       "Description.Visibility",
	"watchers_total_count":             "Description.WatchersCount",
	"web_commit_signoff_required":      "Description.RepositorySettings.WebCommitSignoffRequired",
}
...
var listRepoCollaboratorsFilters = map[string]string{
	"collaborator_id":      "Description.CollaboratorID",
	"collaborator_type":    "Description.CollaboratorType",
...
// ==========================  START: RepositoryPermission =============================

type RepositoryPermission struct {
	ResourceID      string                                 `json:"resource_id"`
	PlatformID      string                                 `json:"platform_id"`
	Description     github.RepositoryPermissionDescription `json:"Description"`
	Metadata        github.Metadata                        `json:"metadata"`
	DescribedBy     string                                 `json:"described_by"`
	ResourceType    string                                 `json:"resource_type"`
	IntegrationType string                                 `json:"integration_type"`
...
type RepositoryPermissionHit struct {
	ID      string               `json:"_id"`
	Score   float64              `json:"_score"`
	Index   string               `json:"_index"`
	Type    string               `json:"_type"`
	Version int64                `json:"_version,omitempty"`
	Source  RepositoryPermission `json:"_source"`
	Sort    []interface{}        `json:"sort"`
}

type RepositoryPermissionHits struct {
	Total essdk.SearchTotal         `json:"total"`
	Hits  []RepositoryPermissionHit `json:"hits"`
}

type RepositoryPermissionSearchResponse struct {
	PitID string                   `json:"pit_id"`
	Hits  RepositoryPermissionHits `json:"hits"`
}

type RepositoryPermissionPaginator struct {
	paginator *essdk.BaseESPaginator
}

func (k Client) NewRepositoryPermissionPaginator(filters []essdk.BoolFilter, limit *int64) (RepositoryPermissionPaginator, error) {
	paginator, err := essdk.NewPaginator(k.ES(), "github_repository_permission", filters, limit)
	if err != nil {
		return RepositoryPermissionPaginator{}, err
	}

	p := RepositoryPermissionPaginator{
		paginator: paginator,
	}
...
func (p RepositoryPermissionPaginator) HasNext() bool {
	return !p.paginator.Done()
}

func (p RepositoryPermissionPaginator) Close(ctx context.Context) error {
	return p.paginator.Deallocate(ctx)
}

func (p RepositoryPermissionPaginator) NextPage(ctx context.Context) ([]RepositoryPermission, error) {
	var response RepositoryPermissionSearchResponse
	err := p.paginator.Search(ctx, &response)
	if err != nil {
		return nil, err
	}

	var values []RepositoryPermission
	for _, hit := range response.Hits.Hits {
		values = append(values, hit.Source)
	}
...
var listRepositoryPermissionFilters = map[string]string{
	...
	"repository_name":      "Description.RepositoryName",
	"role_name":            "Description.RoleName",
}

func ListRepositoryPermission(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
	plugin.Logger(ctx).Trace("ListRepositoryPermission")
	runtime.GC()
	...
	ke, err := essdk.NewClientCached(cfg, d.ConnectionCache, ctx)
	if err != nil {
		plugin.Logger(ctx).Error("ListRepositoryPermission NewClientCached", "error", err)
		return nil, err
	}
	k := Client{Client: ke}
	...
	sc, err := steampipesdk.NewSelfClientCached(ctx, d.ConnectionCache)
	if err != nil {
		plugin.Logger(ctx).Error("ListRepositoryPermission NewSelfClientCached", "error", err)
		return nil, err
	}
	integrationId, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyIntegrationID)
	if err != nil {
		plugin.Logger(ctx).Error("ListRepositoryPermission GetConfigTableValueOrNil for OpenGovernanceConfigKeyIntegrationID", "error", err)
		return nil, err
	}
	encodedResourceCollectionFilters, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyResourceCollectionFilters)
	if err != nil {
		plugin.Logger(ctx).Error("ListRepositoryPermission GetConfigTableValueOrNil for OpenGovernanceConfigKeyResourceCollectionFilters", "error", err)
		return nil, err
	}
	clientType, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyClientType)
	if err != nil {
		plugin.Logger(ctx).Error("ListRepositoryPermission GetConfigTableValueOrNil for OpenGovernanceConfigKeyClientType", "error", err)
		return nil, err
	}

	paginator, err := k.NewRepositoryPermissionPaginator(essdk.BuildFilter(ctx, d.QueryContext, listRepositoryPermissionFilters, integrationId, encodedResourceCollectionFilters, clientType), d.QueryContext.Limit)
	if err != nil {
		plugin.Logger(ctx).Error("ListRepositoryPermission NewRepositoryPermissionPaginator", "error", err)
		return nil, err
	}
	...
	for paginator.HasNext() {
		page, err := paginator.NextPage(ctx)
		if err != nil {
			plugin.Logger(ctx).Error("ListRepositoryPermission paginator.NextPage", "error", err)
			return nil, err
		}
...
func GetRepositoryPermission(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
	plugin.Logger(ctx).Trace("GetRepositoryPermission")
	runtime.GC()
	// create service
	cfg := essdk.GetConfig(d.Connection)
	ke, err := essdk.NewClientCached(cfg, d.ConnectionCache, ctx)
	...
	limit := int64(1)
	paginator, err := k.NewRepositoryPermissionPaginator(essdk.BuildFilter(ctx, d.QueryContext, getRepositoryPermissionFilters, integrationId, encodedResourceCollectionFilters, clientType), &limit)
	if err != nil {
		return nil, err
	}
...
type Webhook struct {
	ResourceID      string                    `json:"resource_id"`
	PlatformID      string                    `json:"platform_id"`
	Description     github.WebhookDescription `json:"Description"`
	Metadata        github.Metadata           `json:"metadata"`
	DescribedBy     string                    `json:"described_by"`
	ResourceType    string                    `json:"resource_type"`
	IntegrationType string                    `json:"integration_type"`
...
func (k Client) NewWebhookPaginator(filters []essdk.BoolFilter, limit *int64) (WebhookPaginator, error) {
	paginator, err := essdk.NewPaginator(k.ES(), "github_repository_webhook", filters, limit)
	if err != nil {
...
// ==========================  START: ArtifactAIModel =============================

type ArtifactAIModel struct {
	ResourceID      string                            `json:"resource_id"`
	PlatformID      string                            `json:"platform_id"`
	Description     github.ArtifactAIModelDescription `json:"Description"`
	Metadata        github.Metadata                   `json:"metadata"`
	DescribedBy     string                            `json:"described_by"`
	ResourceType    string                            `json:"resource_type"`
	IntegrationType string                            `json:"integration_type"`
...
type ArtifactAIModelHit struct {
	ID      string          `json:"_id"`
	Score   float64         `json:"_score"`
	Index   string          `json:"_index"`
	Type    string          `json:"_type"`
	Version int64           `json:"_version,omitempty"`
	Source  ArtifactAIModel `json:"_source"`
	Sort    []interface{}   `json:"sort"`
}

type ArtifactAIModelHits struct {
	Total essdk.SearchTotal    `json:"total"`
	Hits  []ArtifactAIModelHit `json:"hits"`
}

type ArtifactAIModelSearchResponse struct {
	PitID string              `json:"pit_id"`
	Hits  ArtifactAIModelHits `json:"hits"`
}

type ArtifactAIModelPaginator struct {
	paginator *essdk.BaseESPaginator
}

func (k Client) NewArtifactAIModelPaginator(filters []essdk.BoolFilter, limit *int64) (ArtifactAIModelPaginator, error) {
	paginator, err := essdk.NewPaginator(k.ES(), "github_artifact_ai_model", filters, limit)
	if err != nil {
		return ArtifactAIModelPaginator{}, err
	}

	p := ArtifactAIModelPaginator{
		paginator: paginator,
	}
...
func (p ArtifactAIModelPaginator) HasNext() bool {
	return !p.paginator.Done()
}

func (p ArtifactAIModelPaginator) Close(ctx context.Context) error {
	return p.paginator.Deallocate(ctx)
}

func (p ArtifactAIModelPaginator) NextPage(ctx context.Context) ([]ArtifactAIModel, error) {
	var response ArtifactAIModelSearchResponse
	err := p.paginator.Search(ctx, &response)
	if err != nil {
		return nil, err
	}

	var values []ArtifactAIModel
	for _, hit := range response.Hits.Hits {
		values = append(values, hit.Source)
	}
...
var listArtifactAIModelFilters = map[string]string{
...
func ListArtifactAIModel(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
	plugin.Logger(ctx).Trace("ListArtifactAIModel")
	runtime.GC()
	...
	ke, err := essdk.NewClientCached(cfg, d.ConnectionCache, ctx)
	if err != nil {
		plugin.Logger(ctx).Error("ListArtifactAIModel NewClientCached", "error", err)
		return nil, err
	}
	k := Client{Client: ke}
	...
	sc, err := steampipesdk.NewSelfClientCached(ctx, d.ConnectionCache)
	if err != nil {
		plugin.Logger(ctx).Error("ListArtifactAIModel NewSelfClientCached", "error", err)
		return nil, err
	}
	integrationId, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyIntegrationID)
	if err != nil {
		plugin.Logger(ctx).Error("ListArtifactAIModel GetConfigTableValueOrNil for OpenGovernanceConfigKeyIntegrationID", "error", err)
		return nil, err
	}
	encodedResourceCollectionFilters, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyResourceCollectionFilters)
	if err != nil {
		plugin.Logger(ctx).Error("ListArtifactAIModel GetConfigTableValueOrNil for OpenGovernanceConfigKeyResourceCollectionFilters", "error", err)
		return nil, err
	}
	clientType, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyClientType)
	if err != nil {
		plugin.Logger(ctx).Error("ListArtifactAIModel GetConfigTableValueOrNil for OpenGovernanceConfigKeyClientType", "error", err)
		return nil, err
	}

	paginator, err := k.NewArtifactAIModelPaginator(essdk.BuildFilter(ctx, d.QueryContext, listArtifactAIModelFilters, integrationId, encodedResourceCollectionFilters, clientType), d.QueryContext.Limit)
	if err != nil {
		plugin.Logger(ctx).Error("ListArtifactAIModel NewArtifactAIModelPaginator", "error", err)
		return nil, err
	}
	...
	for paginator.HasNext() {
		page, err := paginator.NextPage(ctx)
		if err != nil {
			plugin.Logger(ctx).Error("ListArtifactAIModel paginator.NextPage", "error", err)
			return nil, err
		}
...
var getArtifactAIModelFilters = map[string]string{
	"extensions":           "Description.Extensions",
	"name":                 "Description.Name",
	"repository_full_name": "Description.RepositoryFullName",
	"repository_id":        "Description.RepositoryID",
...
func GetArtifactAIModel(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
	plugin.Logger(ctx).Trace("GetArtifactAIModel")
	runtime.GC()
	// create service
	cfg := essdk.GetConfig(d.Connection)
	ke, err := essdk.NewClientCached(cfg, d.ConnectionCache, ctx)
	...
	limit := int64(1)
	paginator, err := k.NewArtifactAIModelPaginator(essdk.BuildFilter(ctx, d.QueryContext, getArtifactAIModelFilters, integrationId, encodedResourceCollectionFilters, clientType), &limit)
	if err != nil {
		return nil, err
	}
...
// ==========================  START: OrganizationRoleAssignment =============================

type OrganizationRoleAssignment struct {
	ResourceID      string                                       `json:"resource_id"`
	PlatformID      string                                       `json:"platform_id"`
	Description     github.OrganizationRoleAssignmentDescription `json:"Description"`
	Metadata        github.Metadata                              `json:"metadata"`
	DescribedBy     string                                       `json:"described_by"`
	ResourceType    string                                       `json:"resource_type"`
	IntegrationType string                                       `json:"integration_type"`
...
type OrganizationRoleAssignmentHit struct {
	ID      string                     `json:"_id"`
	Score   float64                    `json:"_score"`
	Index   string                     `json:"_index"`
	Type    string                     `json:"_type"`
	Version int64                      `json:"_version,omitempty"`
	Source  OrganizationRoleAssignment `json:"_source"`
	Sort    []interface{}              `json:"sort"`
}

type OrganizationRoleAssignmentHits struct {
	Total essdk.SearchTotal               `json:"total"`
	Hits  []OrganizationRoleAssignmentHit `json:"hits"`
}

type OrganizationRoleAssignmentSearchResponse struct {
	PitID string                         `json:"pit_id"`
	Hits  OrganizationRoleAssignmentHits `json:"hits"`
}

type OrganizationRoleAssignmentPaginator struct {
	paginator *essdk.BaseESPaginator
}

func (k Client) NewOrganizationRoleAssignmentPaginator(filters []essdk.BoolFilter, limit *int64) (OrganizationRoleAssignmentPaginator, error) {
	paginator, err := essdk.NewPaginator(k.ES(), "github_organization_roleassignment", filters, limit)
	if err != nil {
		return OrganizationRoleAssignmentPaginator{}, err
	}

	p := OrganizationRoleAssignmentPaginator{
		paginator: paginator,
	}
...
func (p OrganizationRoleAssignmentPaginator) HasNext() bool {
	return !p.paginator.Done()
}

func (p OrganizationRoleAssignmentPaginator) Close(ctx context.Context) error {
	return p.paginator.Deallocate(ctx)
}

func (p OrganizationRoleAssignmentPaginator) NextPage(ctx context.Context) ([]OrganizationRoleAssignment, error) {
	var response OrganizationRoleAssignmentSearchResponse
	err := p.paginator.Search(ctx, &response)
	if err != nil {
		return nil, err
	}

	var values []OrganizationRoleAssignment
	for _, hit := range response.Hits.Hits {
		values = append(values, hit.Source)
	}
...
func ListOrganizationRoleAssignment(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
	plugin.Logger(ctx).Trace("ListOrganizationRoleAssignment")
	runtime.GC()
	...
	ke, err := essdk.NewClientCached(cfg, d.ConnectionCache, ctx)
	if err != nil {
		plugin.Logger(ctx).Error("ListOrganizationRoleAssignment NewClientCached", "error", err)
		return nil, err
	}
	k := Client{Client: ke}
	...
	sc, err := steampipesdk.NewSelfClientCached(ctx, d.ConnectionCache)
	if err != nil {
		plugin.Logger(ctx).Error("ListOrganizationRoleAssignment NewSelfClientCached", "error", err)
		return nil, err
	}
	integrationId, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyIntegrationID)
	if err != nil {
		plugin.Logger(ctx).Error("ListOrganizationRoleAssignment GetConfigTableValueOrNil for OpenGovernanceConfigKeyIntegrationID", "error", err)
		return nil, err
	}
	encodedResourceCollectionFilters, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyResourceCollectionFilters)
	if err != nil {
		plugin.Logger(ctx).Error("ListOrganizationRoleAssignment GetConfigTableValueOrNil for OpenGovernanceConfigKeyResourceCollectionFilters", "error", err)
		return nil, err
	}
	clientType, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyClientType)
	if err != nil {
		plugin.Logger(ctx).Error("ListOrganizationRoleAssignment GetConfigTableValueOrNil for OpenGovernanceConfigKeyClientType", "error", err)
		return nil, err
	}

	paginator, err := k.NewOrganizationRoleAssignmentPaginator(essdk.BuildFilter(ctx, d.QueryContext, listOrganizationRoleAssignmentFilters, integrationId, encodedResourceCollectionFilters, clientType), d.QueryContext.Limit)
	if err != nil {
		plugin.Logger(ctx).Error("ListOrganizationRoleAssignment NewOrganizationRoleAssignmentPaginator", "error", err)
		return nil, err
	}
	...
	for paginator.HasNext() {
		page, err := paginator.NextPage(ctx)
		if err != nil {
			plugin.Logger(ctx).Error("ListOrganizationRoleAssignment paginator.NextPage", "error", err)
			return nil, err
		}
...
func GetOrganizationRoleAssignment(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
	plugin.Logger(ctx).Trace("GetOrganizationRoleAssignment")
	runtime.GC()
	// create service
	cfg := essdk.GetConfig(d.Connection)
	ke, err := essdk.NewClientCached(cfg, d.ConnectionCache, ctx)
	...
	limit := int64(1)
	paginator, err := k.NewOrganizationRoleAssignmentPaginator(essdk.BuildFilter(ctx, d.QueryContext, getOrganizationRoleAssignmentFilters, integrationId, encodedResourceCollectionFilters, clientType), &limit)
	if err != nil {
		return nil, err
	}
...
// ==========================  END: OrganizationRoleAssignment =============================

// ==========================  START: OrganizationRoleDefinition =============================

type OrganizationRoleDefinition struct {
	ResourceID      string                                       `json:"resource_id"`
	PlatformID      string                                       `json:"platform_id"`
	Description     github.OrganizationRoleDefinitionDescription `json:"Description"`
	Metadata        github.Metadata                              `json:"metadata"`
	DescribedBy     string                                       `json:"described_by"`
	ResourceType    string                                       `json:"resource_type"`
	IntegrationType string                                       `json:"integration_type"`
...
type OrganizationRoleDefinitionHit struct {
	ID      string                     `json:"_id"`
	Score   float64                    `json:"_score"`
	Index   string                     `json:"_index"`
	Type    string                     `json:"_type"`
	Version int64                      `json:"_version,omitempty"`
	Source  OrganizationRoleDefinition `json:"_source"`
	Sort    []interface{}              `json:"sort"`
}

type OrganizationRoleDefinitionHits struct {
	Total essdk.SearchTotal               `json:"total"`
	Hits  []OrganizationRoleDefinitionHit `json:"hits"`
}

type OrganizationRoleDefinitionSearchResponse struct {
	PitID string                         `json:"pit_id"`
	Hits  OrganizationRoleDefinitionHits `json:"hits"`
}

type OrganizationRoleDefinitionPaginator struct {
	paginator *essdk.BaseESPaginator
}

func (k Client) NewOrganizationRoleDefinitionPaginator(filters []essdk.BoolFilter, limit *int64) (OrganizationRoleDefinitionPaginator, error) {
	paginator, err := essdk.NewPaginator(k.ES(), "github_organization_roledefinition", filters, limit)
	if err != nil {
		return OrganizationRoleDefinitionPaginator{}, err
	}

	p := OrganizationRoleDefinitionPaginator{
		paginator: paginator,
	}
...
func (p OrganizationRoleDefinitionPaginator) HasNext() bool {
	return !p.paginator.Done()
}

func (p OrganizationRoleDefinitionPaginator) Close(ctx context.Context) error {
	return p.paginator.Deallocate(ctx)
}

func (p OrganizationRoleDefinitionPaginator) NextPage(ctx context.Context) ([]OrganizationRoleDefinition, error) {
	var response OrganizationRoleDefinitionSearchResponse
	err := p.paginator.Search(ctx, &response)
	if err != nil {
		return nil, err
	}

	var values []OrganizationRoleDefinition
	for _, hit := range response.Hits.Hits {
		values = append(values, hit.Source)
	}
...
var listOrganizationRoleDefinitionFilters = map[string]string{
	"base_role":       "Description.BaseRole",
	"created_at":      "Description.CreatedAt",
	"description":     "Description.Description",
	"id":              "Description.Id",
...
func ListOrganizationRoleDefinition(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
	plugin.Logger(ctx).Trace("ListOrganizationRoleDefinition")
	runtime.GC()
	...
	ke, err := essdk.NewClientCached(cfg, d.ConnectionCache, ctx)
	if err != nil {
		plugin.Logger(ctx).Error("ListOrganizationRoleDefinition NewClientCached", "error", err)
		return nil, err
	}
	k := Client{Client: ke}
	...
	sc, err := steampipesdk.NewSelfClientCached(ctx, d.ConnectionCache)
	if err != nil {
		plugin.Logger(ctx).Error("ListOrganizationRoleDefinition NewSelfClientCached", "error", err)
		return nil, err
	}
	integrationId, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyIntegrationID)
	if err != nil {
		plugin.Logger(ctx).Error("ListOrganizationRoleDefinition GetConfigTableValueOrNil for OpenGovernanceConfigKeyIntegrationID", "error", err)
		return nil, err
	}
	encodedResourceCollectionFilters, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyResourceCollectionFilters)
	if err != nil {
		plugin.Logger(ctx).Error("ListOrganizationRoleDefinition GetConfigTableValueOrNil for OpenGovernanceConfigKeyResourceCollectionFilters", "error", err)
		return nil, err
	}
	clientType, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyClientType)
	if err != nil {
		plugin.Logger(ctx).Error("ListOrganizationRoleDefinition GetConfigTableValueOrNil for OpenGovernanceConfigKeyClientType", "error", err)
		return nil, err
	}

	paginator, err := k.NewOrganizationRoleDefinitionPaginator(essdk.BuildFilter(ctx, d.QueryContext, listOrganizationRoleDefinitionFilters, integrationId, encodedResourceCollectionFilters, clientType), d.QueryContext.Limit)
	if err != nil {
		plugin.Logger(ctx).Error("ListOrganizationRoleDefinition NewOrganizationRoleDefinitionPaginator", "error", err)
		return nil, err
	}
	...
	for paginator.HasNext() {
		page, err := paginator.NextPage(ctx)
		if err != nil {
			plugin.Logger(ctx).Error("ListOrganizationRoleDefinition paginator.NextPage", "error", err)
			return nil, err
		}
...
var getOrganizationRoleDefinitionFilters = map[string]string{
	"base_role":       "Description.BaseRole",
	"created_at":      "Description.CreatedAt",
	"description":     "Description.Description",
	"id":              "Description.Id",
...
func GetOrganizationRoleDefinition(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
	plugin.Logger(ctx).Trace("GetOrganizationRoleDefinition")
	runtime.GC()
	// create service
	cfg := essdk.GetConfig(d.Connection)
	ke, err := essdk.NewClientCached(cfg, d.ConnectionCache, ctx)
	...
	limit := int64(1)
	paginator, err := k.NewOrganizationRoleDefinitionPaginator(essdk.BuildFilter(ctx, d.QueryContext, getOrganizationRoleDefinitionFilters, integrationId, encodedResourceCollectionFilters, clientType), &limit)
	if err != nil {
		return nil, err
	}
...
// ==========================  END: OrganizationRoleDefinition =============================

// ==========================  START: OrganizationToken =============================

type OrganizationToken struct {
	ResourceID      string                              `json:"resource_id"`
	PlatformID      string                              `json:"platform_id"`
	Description     github.OrganizationTokenDescription `json:"Description"`
	Metadata        github.Metadata                     `json:"metadata"`
	DescribedBy     string                              `json:"described_by"`
	ResourceType    string                              `json:"resource_type"`
	IntegrationType string                              `json:"integration_type"`
...
type OrganizationTokenHit struct {
	ID      string            `json:"_id"`
	Score   float64           `json:"_score"`
	Index   string            `json:"_index"`
	Type    string            `json:"_type"`
	Version int64             `json:"_version,omitempty"`
	Source  OrganizationToken `json:"_source"`
	Sort    []interface{}     `json:"sort"`
}

type OrganizationTokenHits struct {
	Total essdk.SearchTotal      `json:"total"`
	Hits  []OrganizationTokenHit `json:"hits"`
}

type OrganizationTokenSearchResponse struct {
	PitID string                `json:"pit_id"`
	Hits  OrganizationTokenHits `json:"hits"`
}

type OrganizationTokenPaginator struct {
	paginator *essdk.BaseESPaginator
}

func (k Client) NewOrganizationTokenPaginator(filters []essdk.BoolFilter, limit *int64) (OrganizationTokenPaginator, error) {
	paginator, err := essdk.NewPaginator(k.ES(), "github_organization_token", filters, limit)
	if err != nil {
		return OrganizationTokenPaginator{}, err
	}

	p := OrganizationTokenPaginator{
		paginator: paginator,
	}
...
func (p OrganizationTokenPaginator) HasNext() bool {
	return !p.paginator.Done()
}

func (p OrganizationTokenPaginator) Close(ctx context.Context) error {
	return p.paginator.Deallocate(ctx)
}

func (p OrganizationTokenPaginator) NextPage(ctx context.Context) ([]OrganizationToken, error) {
	var response OrganizationTokenSearchResponse
	err := p.paginator.Search(ctx, &response)
	if err != nil {
		return nil, err
	}

	var values []OrganizationToken
	for _, hit := range response.Hits.Hits {
		values = append(values, hit.Source)
	}
...
func ListOrganizationToken(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
	plugin.Logger(ctx).Trace("ListOrganizationToken")
	runtime.GC()
	...
	ke, err := essdk.NewClientCached(cfg, d.ConnectionCache, ctx)
	if err != nil {
		plugin.Logger(ctx).Error("ListOrganizationToken NewClientCached", "error", err)
		return nil, err
	}
	k := Client{Client: ke}
	...
	sc, err := steampipesdk.NewSelfClientCached(ctx, d.ConnectionCache)
	if err != nil {
		plugin.Logger(ctx).Error("ListOrganizationToken NewSelfClientCached", "error", err)
		return nil, err
	}
	integrationId, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyIntegrationID)
	if err != nil {
		plugin.Logger(ctx).Error("ListOrganizationToken GetConfigTableValueOrNil for OpenGovernanceConfigKeyIntegrationID", "error", err)
		return nil, err
	}
	encodedResourceCollectionFilters, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyResourceCollectionFilters)
	if err != nil {
		plugin.Logger(ctx).Error("ListOrganizationToken GetConfigTableValueOrNil for OpenGovernanceConfigKeyResourceCollectionFilters", "error", err)
		return nil, err
	}
	clientType, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyClientType)
	if err != nil {
		plugin.Logger(ctx).Error("ListOrganizationToken GetConfigTableValueOrNil for OpenGovernanceConfigKeyClientType", "error", err)
		return nil, err
	}

	paginator, err := k.NewOrganizationTokenPaginator(essdk.BuildFilter(ctx, d.QueryContext, listOrganizationTokenFilters, integrationId, encodedResourceCollectionFilters, clientType), d.QueryContext.Limit)
	if err != nil {
		plugin.Logger(ctx).Error("ListOrganizationToken NewOrganizationTokenPaginator", "error", err)
		return nil, err
	}
	...
	for paginator.HasNext() {
		page, err := paginator.NextPage(ctx)
		if err != nil {
			plugin.Logger(ctx).Error("ListOrganizationToken paginator.NextPage", "error", err)
			return nil, err
		}
...
func GetOrganizationToken(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
	plugin.Logger(ctx).Trace("GetOrganizationToken")
	runtime.GC()
	// create service
	cfg := essdk.GetConfig(d.Connection)
	ke, err := essdk.NewClientCached(cfg, d.ConnectionCache, ctx)
	...
	limit := int64(1)
	paginator, err := k.NewOrganizationTokenPaginator(essdk.BuildFilter(ctx, d.QueryContext, getOrganizationTokenFilters, integrationId, encodedResourceCollectionFilters, clientType), &limit)
	if err != nil {
		return nil, err
	}
