...
func ListCommunityProfile(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
	...
	integrationID, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyIntegrationID)
	if err != nil {
		plugin.Logger(ctx).Error("ListCommunityProfile GetConfigTableValueOrNil for OpenGovernanceConfigKeyIntegrationID", "error", err)
		return nil, err
	}
	encodedResourceCollectionFilters, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyResourceCollectionFilters)
	if err != nil {
	...
	paginator, err := k.NewCommunityProfilePaginator(essdk.BuildFilter(ctx, d.QueryContext, listCommunityProfileFilters, integrationID, encodedResourceCollectionFilters, clientType), d.QueryContext.Limit)
	if err != nil {
...
func GetCommunityProfile(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
	...
	limit := int64(1)
	paginator, err := k.NewCommunityProfilePaginator(essdk.BuildFilter(ctx, d.QueryContext, getCommunityProfileFilters, integrationID, encodedResourceCollectionFilters, clientType), &limit)
	if err != nil {
		return nil, err
	}
...
func ListGitIgnore(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
	...
	integrationID, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyIntegrationID)
	if err != nil {
		plugin.Logger(ctx).Error("ListGitIgnore GetConfigTableValueOrNil for OpenGovernanceConfigKeyIntegrationID", "error", err)
		return nil, err
	}
	encodedResourceCollectionFilters, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyResourceCollectionFilters)
	if err != nil {
	...
	paginator, err := k.NewGitIgnorePaginator(essdk.BuildFilter(ctx, d.QueryContext, listGitIgnoreFilters, integrationID, encodedResourceCollectionFilters, clientType), d.QueryContext.Limit)
	if err != nil {
...
func GetGitIgnore(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
	...
	limit := int64(1)
	paginator, err := k.NewGitIgnorePaginator(essdk.BuildFilter(ctx, d.QueryContext, getGitIgnoreFilters, integrationID, encodedResourceCollectionFilters, clientType), &limit)
	if err != nil {
		return nil, err
	}
...
func ListStargazer(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
	...
	integrationID, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyIntegrationID)
	if err != nil {
		plugin.Logger(ctx).Error("ListStargazer GetConfigTableValueOrNil for OpenGovernanceConfigKeyIntegrationID", "error", err)
		return nil, err
	}
	encodedResourceCollectionFilters, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyResourceCollectionFilters)
	if err != nil {
	...
	paginator, err := k.NewStargazerPaginator(essdk.BuildFilter(ctx, d.QueryContext, listStargazerFilters, integrationID, encodedResourceCollectionFilters, clientType), d.QueryContext.Limit)
	if err != nil {
...
func GetStargazer(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
	...
	limit := int64(1)
	paginator, err := k.NewStargazerPaginator(essdk.BuildFilter(ctx, d.QueryContext, getStargazerFilters, integrationID, encodedResourceCollectionFilters, clientType), &limit)
	if err != nil {
		return nil, err
	}
...
func ListTrafficViewDaily(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
	...
	integrationID, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyIntegrationID)
	if err != nil {
		plugin.Logger(ctx).Error("ListTrafficViewDaily GetConfigTableValueOrNil for OpenGovernanceConfigKeyIntegrationID", "error", err)
		return nil, err
	}
	encodedResourceCollectionFilters, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyResourceCollectionFilters)
	if err != nil {
	...
	paginator, err := k.NewTrafficViewDailyPaginator(essdk.BuildFilter(ctx, d.QueryContext, listTrafficViewDailyFilters, integrationID, encodedResourceCollectionFilters, clientType), d.QueryContext.Limit)
	if err != nil {
...
func GetTrafficViewDaily(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
	...
	limit := int64(1)
	paginator, err := k.NewTrafficViewDailyPaginator(essdk.BuildFilter(ctx, d.QueryContext, getTrafficViewDailyFilters, integrationID, encodedResourceCollectionFilters, clientType), &limit)
	if err != nil {
		return nil, err
	}
...
func ListTrafficViewWeekly(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
	...
	integrationID, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyIntegrationID)
	if err != nil {
		plugin.Logger(ctx).Error("ListTrafficViewWeekly GetConfigTableValueOrNil for OpenGovernanceConfigKeyIntegrationID", "error", err)
		return nil, err
	}
	encodedResourceCollectionFilters, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyResourceCollectionFilters)
	if err != nil {
	...
	paginator, err := k.NewTrafficViewWeeklyPaginator(essdk.BuildFilter(ctx, d.QueryContext, listTrafficViewWeeklyFilters, integrationID, encodedResourceCollectionFilters, clientType), d.QueryContext.Limit)
	if err != nil {
...
func GetTrafficViewWeekly(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
	...
	limit := int64(1)
	paginator, err := k.NewTrafficViewWeeklyPaginator(essdk.BuildFilter(ctx, d.QueryContext, getTrafficViewWeeklyFilters, integrationID, encodedResourceCollectionFilters, clientType), &limit)
	if err != nil {
		return nil, err
	}
...
// ==========================  START: PackageOutputVersion =============================

type PackageOutputVersion struct {
	ResourceID      string                                 `json:"resource_id"`
	PlatformID      string                                 `json:"platform_id"`
	Description     github.PackageOutputVersionDescription `json:"description"`
	Metadata        github.Metadata                        `json:"metadata"`
	DescribedBy     string                                 `json:"described_by"`
	ResourceType    string                                 `json:"resource_type"`
	IntegrationType string                                 `json:"integration_type"`
...
type PackageOutputVersionHit struct {
	ID      string               `json:"_id"`
	Score   float64              `json:"_score"`
	Index   string               `json:"_index"`
	Type    string               `json:"_type"`
	Version int64                `json:"_version,omitempty"`
	Source  PackageOutputVersion `json:"_source"`
	Sort    []interface{}        `json:"sort"`
}

type PackageOutputVersionHits struct {
	Total essdk.SearchTotal         `json:"total"`
	Hits  []PackageOutputVersionHit `json:"hits"`
}

type PackageOutputVersionSearchResponse struct {
	PitID string                   `json:"pit_id"`
	Hits  PackageOutputVersionHits `json:"hits"`
}

type PackageOutputVersionPaginator struct {
	paginator *essdk.BaseESPaginator
}

func (k Client) NewPackageOutputVersionPaginator(filters []essdk.BoolFilter, limit *int64) (PackageOutputVersionPaginator, error) {
	paginator, err := essdk.NewPaginator(k.ES(), "github_package_container", filters, limit)
	if err != nil {
		return PackageOutputVersionPaginator{}, err
	}

	p := PackageOutputVersionPaginator{
		paginator: paginator,
	}
...
func (p PackageOutputVersionPaginator) HasNext() bool {
	return !p.paginator.Done()
}

func (p PackageOutputVersionPaginator) Close(ctx context.Context) error {
	return p.paginator.Deallocate(ctx)
}

func (p PackageOutputVersionPaginator) NextPage(ctx context.Context) ([]PackageOutputVersion, error) {
	var response PackageOutputVersionSearchResponse
	err := p.paginator.Search(ctx, &response)
	if err != nil {
		return nil, err
	}

	var values []PackageOutputVersion
	for _, hit := range response.Hits.Hits {
		values = append(values, hit.Source)
	}
...
var listPackageOutputVersionFilters = map[string]string{}

func ListPackageOutputVersion(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
	plugin.Logger(ctx).Trace("ListPackageOutputVersion")
	runtime.GC()
	...
	ke, err := essdk.NewClientCached(cfg, d.ConnectionCache, ctx)
	if err != nil {
		plugin.Logger(ctx).Error("ListPackageOutputVersion NewClientCached", "error", err)
		return nil, err
	}
	k := Client{Client: ke}
	...
	sc, err := steampipesdk.NewSelfClientCached(ctx, d.ConnectionCache)
	if err != nil {
		plugin.Logger(ctx).Error("ListPackageOutputVersion NewSelfClientCached", "error", err)
		return nil, err
	}
	integrationID, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyIntegrationID)
	if err != nil {
		plugin.Logger(ctx).Error("ListPackageOutputVersion GetConfigTableValueOrNil for OpenGovernanceConfigKeyIntegrationID", "error", err)
		return nil, err
	}
	encodedResourceCollectionFilters, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyResourceCollectionFilters)
	if err != nil {
		plugin.Logger(ctx).Error("ListPackageOutputVersion GetConfigTableValueOrNil for OpenGovernanceConfigKeyResourceCollectionFilters", "error", err)
		return nil, err
	}
	clientType, err := sc.GetConfigTableValueOrNil(ctx, steampipesdk.OpenGovernanceConfigKeyClientType)
	if err != nil {
		plugin.Logger(ctx).Error("ListPackageOutputVersion GetConfigTableValueOrNil for OpenGovernanceConfigKeyClientType", "error", err)
		return nil, err
	}

	paginator, err := k.NewPackageOutputVersionPaginator(essdk.BuildFilter(ctx, d.QueryContext, listPackageOutputVersionFilters, integrationID, encodedResourceCollectionFilters, clientType), d.QueryContext.Limit)
	if err != nil {
		plugin.Logger(ctx).Error("ListPackageOutputVersion NewPackageOutputVersionPaginator", "error", err)
		return nil, err
	}
	...
	for paginator.HasNext() {
		page, err := paginator.NextPage(ctx)
		if err != nil {
			plugin.Logger(ctx).Error("ListPackageOutputVersion paginator.NextPage", "error", err)
			return nil, err
		}
...
var getPackageOutputVersionFilters = map[string]string{}

func GetPackageOutputVersion(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
	plugin.Logger(ctx).Trace("GetPackageOutputVersion")
	runtime.GC()
	// create service
	cfg := essdk.GetConfig(d.Connection)
	ke, err := essdk.NewClientCached(cfg, d.ConnectionCache, ctx)
	...
	limit := int64(1)
	paginator, err := k.NewPackageOutputVersionPaginator(essdk.BuildFilter(ctx, d.QueryContext, getPackageOutputVersionFilters, integrationID, encodedResourceCollectionFilters, clientType), &limit)
	if err != nil {
		return nil, err
	}
