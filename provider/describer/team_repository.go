...
func GetAllTeamsRepositories(ctx context.Context, githubClient provider.GitHubClient, stream *models.StreamSender) ([]models.Resource, error) {
...
func GetTeamRepositories(ctx context.Context, githubClient provider.GitHubClient, stream *models.StreamSender, org, slug string) ([]models.Resource, error) {
