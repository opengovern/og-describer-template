...
func processMachine(ctx context.Context, handler *resilientbridge.ResilientBridge, appName, resourceID string) (*model.MachineJSON, error) {
	var machine model.MachineJSON
	baseURL := "/v1/apps/"
