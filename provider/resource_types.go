...
var ResourceTypes = map[string]model.ResourceType{
	...
	"Github/Repository": {
		...
		Labels:        map[string]string{},
		Annotations:   map[string]string{},
		ListDescriber: DescribeByGithub(describer.GetRepositoryList), // Uses resilient SDK based GetRepositoryList
		GetDescriber:  DescribeSingleByRepo(describer.GetRepository), // Uses resilient SDK based GetRepository
	},
